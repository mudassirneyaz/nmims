...
<h4><?php $date = strtotime($row['update_date']);
          echo date('d',$date);  ?></h4> <span><?php $date = strtotime($row['update_date']);
...
<div class="event-heading">
 <h3><?php echo $row['update_sub'] ; ?></h3>
<p><?php echo $row['update_desc'] ; ?></p>
</div>
...
<div class="row">
  ...
  <?php
          $post_image = $row['update_img'];
          $images = explode(",",$post_image);
                 foreach($images as $image)
                 { ?>
                  <div class="col-md-4">
                    <img id="<?php echo $row['id'] ; ?>" src=" ../root/update_images/<?php echo $image ; ?>" alt="" style="width:100%;height: 350px;">
<!-- The Modal -->
